package moe.shimmerfly.shimmerpatch.install
...
data class ApkInstallSet(
    ...
    companion object {
        ...
        /**
         * Reads the signer digest of an APK file using [moe.shimmerfly.shimmerpatch.patch.util.ApkSignatureHelper], which parses the
        ...
        private fun readSignerDigest(file: File): String {
            val signatures = moe.shimmerfly.shimmerpatch.patch.util.ApkSignatureHelper.getApkSignatures(file.absolutePath)
