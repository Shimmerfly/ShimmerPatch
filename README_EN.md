...
NPatch Remote API is a lightweight Android SDK for the Xposed module settings UI (the module companion app). It lets a module app securely connect to NPatch Manager in Local mode and read and write Remote Preferences and Files in the NPatch Remote Store, partitioned by module package.
