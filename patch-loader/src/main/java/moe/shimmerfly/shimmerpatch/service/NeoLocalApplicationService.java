...
import moe.shimmerfly.shimmerpatch.util.ManagerRemoteServiceBridge;
import moe.shimmerfly.shimmerpatch.util.ModuleLoader;
...
public class NeoLocalApplicationService extends IFrameworkService.Stub {
    ...
    private static org.matrix.vector.ipc.IModuleService managerBackedService(
        ...
        try {
            ...
            return new moe.shimmerfly.shimmerpatch.util.LocalInjectedModuleService(context, modulePackageName);
        }
    }
